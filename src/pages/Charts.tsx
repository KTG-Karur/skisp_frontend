...
const Charts = () => {
    ...
    const pieChart: any = {
        ...
        options: {
            ...
            colors: ['#ef7f1b', '#805dca', '#00ab55', '#e7515a', '#e2a03f'],
            responsive: [
                {
                    breakpoint: 480,
                    options: {
    ...
    const polarAreaChart: any = {
        ...
        options: {
            ...
            colors: ['#ef7f1b', '#805dca', '#00ab55', '#e7515a', '#e2a03f', '#2196f3', '#3b3f5c'],
            stroke: {
                show: false,
            },
            responsive: [
